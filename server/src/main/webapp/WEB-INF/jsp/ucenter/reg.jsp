                ...
                <div class="login-box-body">
                    ...
                    <form>
                        ...
                        <div class="row">
                            <!-- /.col -->
                            <div class="col-xs-12">
                                <button type="submit" class="btn btn-primary btn-block btn-flat" onclick="registerWithEmail()">接受服务协议并注册</button>
                            </div>
                            <!-- /.col -->
                        </div>
                    </form>
...
<script src="${basePath}/resources/ucenter/js/jquery.min.js"></script>
<script src="${basePath}/resources/ucenter/js/bootstrap.min.js"></script>
<script src="${basePath}/resources/ucenter/js/reg.js"></script>
</body>
</html>