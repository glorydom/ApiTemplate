...
<div id="main">
	<div id="toolbar">
		<shiro:hasPermission name="workflow:deploy"><a class="waves-effect waves-button" href="javascript:;" onclick="completeAction()"><i class="zmdi zmdi-plus"></i> 完成任务</a></shiro:hasPermission>
	</div>
...
$(function() {
	...
	$table.bootstrapTable({
		url: '${basePath}/chqs/workflow/mytasks',
		height: getHeight(),
		striped: true,
		search: true,
		showRefresh: true,
