...
public class MybatisGeneratorUtil {
	...
	public static void generator(
		...
		System.out.println("项目的路径是：" + targetProject);
		...
		try {
			...
			String targetProjectSqlMap = basePath  + "service";
            System.out.println("targetProjectSqlMap -> " + targetProjectSqlMap);
		...
		String servicePath = basePath  + "service" + "/src/main/java/" + packageName.replaceAll("\\.", "/") + "/rpc/api";
		String serviceImplPath = basePath  + "service" + "/src/main/java/" + packageName.replaceAll("\\.", "/") + "/rpc/service/impl";
        ...
        if (!servicePathDir.exists()) {
            servicePathDir.mkdirs();
        }
        File serviceImplPatDir = new File(serviceImplPath);
        if (!serviceImplPatDir.exists()) {
            serviceImplPatDir.mkdirs();
        }
	...
	public static void main(String[] args) throws Exception {
		String MODULE = "zheng-wechat-app";
		String DATABASE = "plaza";
		String TABLE_PREFIX = "";
		String PACKAGE_NAME = "com.zheng.wechat.dao";
		String JDBC_DRIVER = "com.mysql.jdbc.Driver";
		String JDBC_URL ="jdbc\\:mysql\\://192.168.0.104\\:3306/plaza?useUnicode\\=true&characterEncoding\\=utf-8&autoReconnect\\=true";
		String JDBC_USERNAME = "plaza";
		String JDBC_PASSWORD = "g05kxoKAa+qzODorZjj0EQ==";
